...
<div class="container mx-auto px-4 py-6">
    <div class="bg-white dark:bg-slate-800 rounded-lg shadow-md overflow-hidden">
        ...
        <div class="bg-blue-600 dark:bg-blue-800 text-white p-4 flex justify-between items-center">
            <h1 class="text-2xl font-semibold">Account Bewerken</h1>
        ...
        <div class="p-6">
            ...
            <form method="POST" action="{{ route('accounts.update', $user) }}" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-gray-50 dark:bg-slate-700 p-5 rounded-lg space-y-4">
                        ...
                        <!-- Wachtwoord -->
                        <div>
                            <label for="password" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Nieuw wachtwoord</label>
                            <input type="password" name="password" id="password"
                                class="w-full rounded-md border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-gray-900 dark:text-gray-100 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-30">
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Laat leeg om het huidige wachtwoord te behouden</p>
                        </div>

                        <!-- Wachtwoord bevestiging -->
                        <div>
                            <label for="password_confirmation" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Bevestig nieuw wachtwoord</label>
