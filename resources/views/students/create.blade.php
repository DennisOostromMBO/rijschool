...
<div class="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-lg w-full max-w-3xl mx-auto mt-8">
    <div class="space-y-4 mb-6">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Nieuwe Student Toevoegen</h1>
            ...
            <div>
                ...
                <div class="mt-1">
                    <input type="date" name="birth_date" value="{{ old('birth_date') }}" required
                        class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                </div>
                @error('birth_date')
                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                @enderror
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input type="tel" name="mobile" value="{{ old('mobile') }}" required
                            class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 dark:bg-gray-700 dark:border-gray-600 dark:text-white @error('email') border-red-500 @enderror">
                    </div>
                    @error('mobile')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
