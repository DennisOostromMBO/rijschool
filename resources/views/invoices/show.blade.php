    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6 mb-6">
            ...
            <dl class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Bedrag (excl. BTW)</dt>
                    <dd class="text-sm text-gray-800 dark:text-gray-200">€{{ number_format($invoice->amount_excl_vat, 2) }}</dd>
                </div>
                <div>
