...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-blue-600 dark:bg-blue-800 text-white p-4 flex justify-between items-center rounded-t-lg">
        <h1 class="text-2xl font-semibold text-white">Notificatie Bewerken</h1>
        ...
        <form method="POST" action="{{ route('notifications.update', $notification) }}" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="col-span-2">
                    ...
                    <input type="text" name="title" id="title" value="{{ old('title', $notification->title) }}" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-slate-700 text-gray-900 dark:text-white focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-30" required>
                    @error('title')
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="message" id="message" rows="3" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-slate-700 text-gray-900 dark:text-white focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-30" required>{{ old('message', $notification->message) }}</textarea>
                    @error('message')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <select name="notification_type" id="notification_type" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-slate-700 text-gray-900 dark:text-white focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-30" required>
                        ...
                        <option value="Sick" {{ old('notification_type', $notification->notification_type) == 'Sick' ? 'selected' : '' }}>Ziekmelding</option>
                        <option value="LessonChange" {{ old('notification_type', $notification->notification_type) == 'LessonChange' ? 'selected' : '' }}>Leswijziging</option>
                        <option value="LessonCancellation" {{ old('notification_type', $notification->notification_type) == 'LessonCancellation' ? 'selected' : '' }}>Lesannulering</option>
                        ...
                        <option value="LessonGoalChange" {{ old('notification_type', $notification->notification_type) == 'LessonGoalChange' ? 'selected' : '' }}>Lesdoel wijziging</option>
                        <option value="LessonAssignment" {{ old('notification_type', $notification->notification_type) == 'LessonAssignment' ? 'selected' : '' }}>Lestoewijzing</option>
                    </select>
                ...
                <div>
                    ...
                    <select name="target_group" id="target_group" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-slate-700 text-gray-900 dark:text-white focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-30" required>
                        ...
                        <option value="Student" {{ old('target_group', $notification->target_group) == 'Student' ? 'selected' : '' }}>Studenten</option>
                        <option value="Instructor" {{ old('target_group', $notification->target_group) == 'Instructor' ? 'selected' : '' }}>Instructeurs</option>
                ...
                <div>
                    ...
                    <input type="date" name="date" id="date" value="{{ old('date', $notification->date ? $notification->date->format('Y-m-d') : date('Y-m-d')) }}" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-slate-700 text-gray-900 dark:text-white focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-30" required>
                    @error('date')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <div class="mt-1 flex items-center">
                        <input type="checkbox" name="is_active" id="is_active" class="rounded dark:bg-slate-700 border-gray-300 dark:border-gray-600 text-blue-600 focus:ring-blue-500" value="1" {{ old('is_active', $notification->is_active) ? 'checked' : '' }}>
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="remark" id="remark" rows="2" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-slate-700 text-gray-900 dark:text-white focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-30">{{ old('remark', $notification->remark) }}</textarea>
                    @error('remark')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                </div>
