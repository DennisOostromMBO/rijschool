        ...
        <div class="min-h-screen flex flex-col justify-center items-center">
            <div class="w-full sm:max-w-md mt-8 px-6 py-8 bg-white dark:bg-slate-800 shadow-lg rounded-lg">
                <a href="/" class="flex flex-col items-center group mb-8">
                    <span class="text-3xl font-extrabold text-blue-600 dark:text-blue-400 group-hover:text-blue-700 dark:group-hover:text-blue-300 transition">Rijschool Vierkante Wielen</span>
                </a>
                {{ $slot }}
            </div>
        </div>
